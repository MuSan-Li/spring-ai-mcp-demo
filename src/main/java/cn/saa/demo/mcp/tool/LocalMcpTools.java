...
/**
 * 本地 MCP 工具实现
 * 使用 @McpToolData 注解定义工具，Spring AI 会自动扫描并注册
 *
...
public class LocalMcpTools {
    ...
    public Map<String, Object> calculatorAdd(@McpToolParam(description = "第一个数字", required = true) Double a,
